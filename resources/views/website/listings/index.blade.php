<x-website.layout :settings="$settings" :title="$label . ' - ' . $settings->site_name">
    ...
    @if ($isJob)
        <section class="page-hero">
            <div
                class="absolute inset-0 bg-[linear-gradient(90deg,rgba(255,255,255,.02)_1px,transparent_1px),linear-gradient(0deg,rgba(255,255,255,.018)_1px,transparent_1px)] bg-[size:128px_128px] opacity-15">
            </div>
            ...
            <div class="page-hero-inner">
                ...
                <h1 class="mt-5 font-display text-5xl leading-tight md:text-7xl">نبني فريقًا يُعِدّ جيلًا لحياةٍ طيّبة
                </h1>
                <p class="mt-8 max-w-3xl text-xl leading-loose text-white/78">
                    وظائفُ قياديةٌ وتخصّصيةٌ وتشغيليةٌ في مؤسساتٍ تخدم الطفل من الميلاد حتى الثامنة عشرة. اعرف مهامّ كلّ
                    وظيفةٍ وشروطها ومؤشّر نجاحها، ثم قدّم عبر استمارةٍ موحّدةٍ مرّةً واحدة.
                </p>

                <div class="mt-10 flex flex-wrap justify-center gap-4">
                    <a href="#vacancies"
                        class="flex items-center gap-2 rounded-full bg-alisary-gold px-8 py-4 font-bold text-alisary-deep transition hover:bg-[#D7B56D]">تصفّح
                        الوظائف</a>
                    <a href="#how"
                        class="flex items-center gap-2 rounded-full border border-white/30 bg-transparent px-8 py-4 font-bold text-white transition hover:bg-white/10">كيف
                        نوظّف؟</a>
                </div>
        ...
        <section class="section-deep text-white">
            <div class="mx-auto grid max-w-7xl gap-px bg-white/10 px-5 lg:grid-cols-3 lg:px-10">
                <article class="value-tile">
                    ...
                    <p class="mt-4 leading-loose text-white/72">خماسية السكينة بوّابةُ عبورٍ غير قابلةٍ للتفاوض: تعيشها
                        قبل أن تُعلّمها. نقيسها سلوكًا لا شعارًا.</p>
                </article>
                <article class="value-tile">
                    <div class="value-icon">
                    ...
                    <p class="mt-4 leading-loose text-white/72">نُقدّم من يُعلّم نفسه ويتكيّف على من يكتفي بما يعرف.
                        التخصّص يُكتسب؛ النزعةُ للتعلّم تُختار.</p>
                </article>
                <article class="value-tile">
                    <div class="value-icon">
                    ...
                    <p class="mt-4 leading-loose text-white/72">كلُّ قائدٍ مسؤولٌ عن إيرادٍ خارجيٍّ متنوّع. نبحث عمّن
                        يرى الفرصة ويصنع القيمة، لا من ينتظر الميزانية.</p>
                </article>
            </div>
        </section>
    @else
        ...
        <section class="section-deep text-white" id="how">
            <div class="mx-auto max-w-7xl px-5 py-20 lg:px-10 lg:py-28">
                <div class="mb-14 text-center">
                    ...
                    <p class="mt-2 text-white/80">مسارٌ موحّدٌ لكل مؤسسات المجموعة. التقديم عبر هذا الموقع فقط، ونتواصل
                        مع كل متقدّم.</p>
                </div>
                ...
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
                    ...
                    <div class="rounded-xl border border-white/10 bg-white/5 p-6">
                        ...
                        <p class="text-sm leading-relaxed text-white/70">نقرأ طلبك بعناية بمساعدة أدوات الذكاء
                            الاصطناعي، ونقيس الاصطفاف القيمي والقابلية للتعلّم — ولا نرفض طلبًا إلا بمراجعةٍ بشرية.</p>
                    </div>
                    <div class="rounded-xl border border-white/10 bg-white/5 p-6">
