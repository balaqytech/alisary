...
class HomeSectionResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'أقسام الرئيسية';

    protected static ?string $modelLabel = 'قسم رئيسي';

    protected static ?string $pluralModelLabel = 'أقسام الرئيسية';
